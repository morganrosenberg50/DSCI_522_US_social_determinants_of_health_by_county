...
```{r density plots for numetric variables, warning=FALSE, fig.cap="Figure 1. Density plots of numeric feature", out.width="100%"}
...
fig_case_per_100k_plot <- ggplotly(case_per_100k_plot)
fig_case_per_100k_plot
```
