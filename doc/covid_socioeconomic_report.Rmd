...
kable(highest_covid_cases,
      caption = "Table 5. Top 5 counties with highest number of cumulative COVID-19 cases.",
      digits = 3)

kable(lowest_covid_cases,
      caption = "Table 6. Top 5 counties with lowest number of cumulative COVID-19 cases",
      digits = 3)
```
